...
import { AlertTriangle, CheckCircle, X, Info, Phone, CreditCard, Database, Smartphone } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 w-full max-w-md shadow-2xl">
        <div className="bg-gradient-to-r from-red-500 to-rose-500 px-6 py-5 rounded-t-xl flex justify-between items-center">
        ...
        <div className="px-6 py-6 max-h-[60vh] overflow-y-auto">
          <div className="space-y-4 text-slate-700 dark:text-slate-300">
            ...
            <div className="flex items-start">
              <div className="w-2 h-2 rounded-full bg-red-500 mr-3 mt-2 flex-shrink-0"></div>
              <p className="font-medium">For urgent data, consider other immediate options</p>
            </div>
            <div className="flex items-start">
              <div className="w-2 h-2 rounded-full bg-red-500 mr-3 mt-2 flex-shrink-0"></div>
          ...
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 p-4 rounded-xl mt-5">
            <div className="flex items-start">
              <Info className="w-5 h-5 text-red-600 dark:text-red-400 mr-3 mt-0.5 flex-shrink-0" strokeWidth={2} />
        ...
        <div className="px-6 py-4 border-t border-slate-200 dark:border-slate-700 flex space-x-3">
          ...
          <button
            onClick={onConfirm}
            className="flex-1 py-3 px-4 bg-gradient-to-r from-red-500 to-rose-500 hover:from-red-600 hover:to-rose-600 text-white font-bold rounded-xl transition-all shadow-lg hover:shadow-xl"
          >
            Continue
          </button>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 w-full max-w-md shadow-2xl">
        <div className="bg-gradient-to-r from-red-500 to-rose-500 px-6 py-5 rounded-t-xl flex justify-between items-center">
          <h3 className="text-xl font-bold text-white flex items-center">
            <Smartphone className="w-6 h-6 mr-3" strokeWidth={2} />
        ...
        <div className="px-6 py-6">
          <div className="bg-slate-50 dark:bg-slate-700/50 rounded-xl p-5 mb-5 border border-slate-200 dark:border-slate-600">
            <div className="flex justify-between items-center mb-3">
              ...
              <span className="text-red-600 dark:text-red-400 font-bold text-lg">{bundle.capacity}GB</span>
            </div>
            <div className="flex justify-between items-center mb-3">
              <span className="text-slate-700 dark:text-slate-300 font-semibold">Network:</span>
              <span className="text-red-600 dark:text-red-400 font-bold">Telecel</span>
            </div>
            <div className="flex justify-between items-center mb-3">
              <span className="text-slate-700 dark:text-slate-300 font-semibold">Duration:</span>
              <span className="text-emerald-600 dark:text-emerald-400 font-bold">No-Expiry</span>
            </div>
            <div className="flex justify-between items-center border-t border-slate-300 dark:border-slate-600 pt-3">
              ...
              <span className="text-red-600 dark:text-red-400 font-bold text-xl">₵{bundle.price}</span>
            </div>
          </div>
          ...
          <div className="mb-5">
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <Phone className="w-5 h-5 text-red-600 dark:text-red-400" strokeWidth={2} />
              </div>
              <input
                type="tel"
                value={phoneNumber}
                onChange={handlePhoneNumberChange}
                className="pl-12 pr-4 py-3 block w-full rounded-xl bg-slate-50 dark:bg-slate-700 border border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:ring-2 focus:ring-red-500 focus:border-red-500 font-semibold text-base transition-all"
                placeholder="020XXXXXXX or 050XXXXXXX"
                required
                autoFocus
              />
            </div>
            <p className="mt-2 text-xs font-medium text-slate-500 dark:text-slate-400">Format: 020 or 050 followed by 7 digits</p>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-amber-800 dark:text-amber-400 text-xs font-medium">
                  Only 020 or 050 numbers supported. Verify carefully - no refunds for incorrect numbers.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              className="flex-1 py-3 px-4 bg-gradient-to-r from-red-500 to-rose-500 hover:from-red-600 hover:to-rose-600 text-white font-bold rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center shadow-lg hover:shadow-xl"
            >
              {isLoading ? (
                <>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-8 max-w-xs w-full mx-auto text-center shadow-2xl">
        <div className="flex justify-center mb-5">
          <div className="relative w-16 h-16">
            ...
            <div className="absolute top-0 w-16 h-16 rounded-full border-3 border-transparent border-t-red-500 animate-spin"></div>
            <div className="absolute inset-3 rounded-xl bg-gradient-to-br from-red-500 to-rose-500 flex items-center justify-center shadow-lg">
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 py-8 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg font-semibold">Premium Data Packages</p>
        </div>
              ...
              {bundles.map((bundle) => (
                <button
                  ...
                  className={`p-5 rounded-xl text-center transition-all border transform hover:scale-105 ${
                    bundle.inStock
                      ? 'bg-slate-50 dark:bg-slate-700/50 border-slate-200 dark:border-slate-600 hover:bg-red-50 dark:hover:bg-red-900/20 hover:border-red-400 dark:hover:border-red-500 cursor-pointer shadow-sm hover:shadow-md'
                      : 'bg-slate-100 dark:bg-slate-700 border-slate-300 dark:border-slate-600 cursor-not-allowed opacity-50'
                  }`}
                >
                  <div className="text-lg font-bold mb-2 text-slate-900 dark:text-white">{bundle.capacity}GB</div>
                  <div className="text-red-600 dark:text-red-400 font-bold text-base mb-1">₵{bundle.price}</div>
                  {!bundle.inStock ? (
